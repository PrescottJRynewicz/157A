...
for index_mass = 1:length(Mass)

    total_mass          = linspace(Mass(index_mass),Mass(index_mass),length(t_total));
    ...
    if index_mass == 1
        fig1 = figure; plot(t_total,u);    title('Velocity vs. Time', 'Fontsize', 16); xlabel('Time [s]'); ylabel('Velocity [m/s]');   hold on;
        fig2 = figure; plot(t_total,h);    title('Altitude vs. Time', 'Fontsize', 16); xlabel('Time [s]'); ylabel('Altitude [m]');     hold on; 
...
%         figure; plot(t_total,rho);  title('Density vs. Time', 'Fontsize', 16);  xlabel('Time [s]'); ylabel('Density [kg/m^3]');
        ...
        figure (fig1); plot(t_total,u);    title('Velocity vs. Time', 'Fontsize', 16); xlabel('Time [s]'); ylabel('Velocity [m/s]');   hold on;
        figure (fig2); plot(t_total,h);    title('Altitude vs. Time', 'Fontsize', 16); xlabel('Time [s]'); ylabel('Altitude [m]');     hold on; 
    end
