...
prop_mass_init      = 10.8/1000;                            % [kg]
total_mass_motor    = 24.1/1000;                            % [kg]
struct_mass_motor   = 9.4/1000;                             % [kg]
...
figure; plot(t_total,u);    title('Velocity vs. Time: C_D = 0.5/1.5', 'Fontsize', 16); xlabel('Time [s]'); ylabel('Velocity [m/s]'); 
