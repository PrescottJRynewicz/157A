...
rho(1)              = 1.225;                                % [kg/m^3]
CD                  = 0.0;                                  % Initial Estimate from Stine
...
figure; plot(t_total,u);    title('Velocity vs. Time: C_D = 0', 'Fontsize', 16); xlabel('Time [s]'); ylabel('Velocity [m/s]'); 
figure; plot(t_total,h);    title('Altitude vs. Time: C_D = 0', 'Fontsize', 16); xlabel('Time [s]'); ylabel('Altitude [m]');
